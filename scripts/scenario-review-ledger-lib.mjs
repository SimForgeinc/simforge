...
export const SCENARIO_REVIEW_PROVENANCE_FILES = [
  ...
  'packages/city-renderer/src/camera-controls.ts',
  'packages/city-renderer/src/environment.ts',
  'packages/city-renderer/src/frame-stats.ts',
  'packages/city-renderer/src/gltf.ts',
  'packages/city-renderer/src/ground-index.ts',
  'packages/city-renderer/src/index.ts',
  'packages/city-renderer/src/manifest.ts',
  'packages/city-renderer/src/materials.ts',
  'packages/city-renderer/src/shadow-atlas.ts',
  'packages/city-renderer/src/streaming.ts',
  'packages/city-renderer/src/types.ts',
  'packages/city-renderer/src/vegetation.ts',
  'packages/city-renderer/src/viewer.ts',
  'packages/prop-catalog/src/catalog.ts',
  'packages/prop-catalog/src/composites.ts',
  'packages/prop-catalog/src/geometry.ts',
  'packages/prop-catalog/src/index.ts',
  'packages/prop-catalog/src/materials.ts',
  'packages/prop-catalog/src/registry.ts',
  'packages/prop-catalog/src/schema.ts',
  'packages/prop-catalog/src/types.ts',
  'packages/prop-catalog/src/builders/construction.ts',
  'packages/prop-catalog/src/builders/hazards.ts',
  'packages/prop-catalog/src/builders/pedestrians.ts',
  'packages/prop-catalog/src/builders/street.ts',
  'packages/prop-catalog/src/builders/vehicles.ts',
];
