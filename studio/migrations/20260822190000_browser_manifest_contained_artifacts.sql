...
-- migration-window: allows manifest-contained trace and annotations declarations in browser recording specs.
BEGIN;
...
VALUES ('20260822190000_browser_manifest_contained_artifacts.sql')
