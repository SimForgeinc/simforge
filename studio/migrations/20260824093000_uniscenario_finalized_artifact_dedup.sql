...
-- Mirror the archive-light review contract enforced by recording-store.ts:
-- camera/image frame archives are explicit opt-in; LiDAR/radar raw archives
-- and their visualisation videos remain default review products.
