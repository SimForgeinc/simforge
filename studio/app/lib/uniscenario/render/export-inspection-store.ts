...
import type { UniScenarioExportInspectionDto } from "./contracts";
...
function capabilityWarnings(value: unknown): UniScenarioExportInspectionDto["capability"]["warnings"] {
...
export async function inspectCompletedExport(
  context: AppContext,
  exportId: string,
): Promise<UniScenarioExportInspectionDto | null> {
