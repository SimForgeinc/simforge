 ...
 * narrative (see `family-classifier` in @simcloud/incident-datasets).
 */
 ...
 * regenerated by `npm run build-category-prior -w @simcloud/incident-datasets`
 * (plan §7 B-3, "bake into collision-templates").
 *
