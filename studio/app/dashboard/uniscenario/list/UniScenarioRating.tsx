...
import type { UniScenarioRatingAggregateDto } from "@/app/lib/uniscenario/contracts";
 ...
 */
export function UniScenarioRating({
  aggregate,
  loading = false,
  saving = false,
  error = null,
  ...
  aggregate?: UniScenarioRatingAggregateDto;
  loading?: boolean;
  saving?: boolean;
  error?: string | null;
  documentName: string;
  ...
  return (
    <div className="mt-2 flex min-h-5 flex-wrap items-center gap-1.5">
      <div
        ...
        data-uniscenario-rating={rating}
      >
        {[1, 2, 3, 4, 5].map((star) => {
      ...
      <span
        ...
        data-uniscenario-rating-aggregate=""
      >
        {saving || loading ? (
