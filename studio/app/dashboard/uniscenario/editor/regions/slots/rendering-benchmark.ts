...
export type RenderingBenchmarkSnapshot = {
  ...
  manifestUrl: string;
  recommended: UniScenarioAuthoringQuality;
...
const FIDELITY_ORDER: readonly UniScenarioAuthoringQuality[] = [
  "roads-only",
  "ultra-low-3d",
  "minimal",
  "high",
...
): UniScenarioAuthoringQuality | null {
...
export function loadRenderingBenchmark(
  ...
  try {
    ...
    if (
      ...
      !parsed.recommended ||
      !UNISCENARIO_AUTHORING_QUALITY_IDS.includes(parsed.recommended) ||
