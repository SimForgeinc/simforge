...
import { OFFICIAL_OPENSCENARIO_140_XSD, validateOpenScenarioXml14 } from "@uniscenarios/openscenario/node";
import { withBoundedSpeedCruiseRestoration, withStableHighSpeedWorldRoutes } from "@uniscenarios/playback";
import {
  buildMapControlPlan,
...
import { parseTemplate, serializeTemplate, validateTemplate, type ScenarioTemplateV2 } from "@uniscenarios/scenario-model";
import {
