...
import { parsePlaybackPair } from "@uniscenarios/playback";
import type { RenderInputFile } from "@uniscenarios/render-runtime";
import { hashFile } from "@uniscenarios/render-runtime";
import { contentHash, parseSimScenarioInput } from "@uniscenarios/sim-engine";
...
async function main(argv: readonly string[]): Promise<void> {
  ...
  process.env.UNISCENARIOS_BROWSER_ENGINE_MODULE ??= pathToFileURL(
    resolve("packages/browser-renderer/dist/index.js"),
  ).href;
