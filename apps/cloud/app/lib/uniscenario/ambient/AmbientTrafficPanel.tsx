...
import { ambientPromotionCapability, nextAmbientSeed, profileForPreset, type AmbientTrafficPreset } from '@uniscenarios/ambient-traffic';
import type { AmbientRobustnessSummary } from '../playback/scenario-worker';
import type { AmbientTrafficProviderId, SumoTrafficStatus } from '@uniscenarios/ambient-traffic';
