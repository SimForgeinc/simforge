import { RenderSpecV3Schema, type RenderSpecV3 } from "@uniscenarios/scenario-model";
import { z } from "zod";
...
export type UniScenarioRenderIntent = z.infer<typeof UniScenarioRenderIntentSchema>;

/** UI-to-control-plane adapter. The server materializes and hashes the immutable intent. */
export const SubmitUniScenarioRenderIntentSchema = z.strictObject({
  schema: z.literal("uniscenario.render-intent-submission/v1"),
  engine: UniScenarioRendererEngineSchema,
  revisionId: PublicIdSchema,
...
export type SubmitUniScenarioRenderIntent = z.infer<typeof SubmitUniScenarioRenderIntentSchema>;
...
export const UniScenarioRendererCapabilitySchema = z.strictObject({
  ...
  backend: UniScenarioRendererEngineSchema,
...
export type UniScenarioRendererCapability = z.infer<typeof UniScenarioRendererCapabilitySchema>;
...
export const RegisterRenderWorkerV2Schema = z.strictObject({
  ...
  engine: UniScenarioRendererCapabilitySchema,
