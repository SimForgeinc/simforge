...
import { EMPTY_AMBIENT_CONFIG_SHA256, type UniScenarioAmbientProvenance } from "@/app/lib/uniscenario/contracts";
import type { MapEntry } from "@/app/lib/uniscenario/maps";
import type { PlaybackBundle } from "@uniscenarios/playback";
import type { AmbientTrafficProviderId } from "@uniscenarios/ambient-traffic";

/** Build deterministic native/off traffic bytes only after an explicit export/render action. */
