...
import { ActorRenderer } from "@uniscenarios/city-renderer";
...
import { authoringRuntimeReady } from "@uniscenarios/editor-core";
...
export type UniScenarioWorldTarget = {
  mapVersionId: string;
  manifestUrl: string;
  label: string;
...
export type UniScenarioWorldState = {
  target: UniScenarioWorldTarget | null;
 ...
 */
export function UniScenarioWorldHost({
  target,
  pendingTarget = false,
  interactive = true,
  onViewerChange,
  ...
  onStateChange: (state: UniScenarioWorldState) => void;
  className?: string;
}) {
  ...
  return (
    <div
      ...
      data-testid="uniscenario-world-host"
      ...
      {retainedTarget ? (
        <CityView
          ...
          onReady={(viewer) => {
            ...
            actorRenderer.group.name = "uniscenario-world-actors";
