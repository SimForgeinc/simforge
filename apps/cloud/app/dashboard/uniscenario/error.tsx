...
import { UniScenarioWorkspaceErrorState } from "./editor/status";
 ...
 * on. `UniScenarioWorkspaceErrorState` renders nothing: it publishes the same failure into the workspace
 ...
 */
export default function UniScenarioError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto flex min-h-64 max-w-3xl flex-col items-center justify-center px-6 text-center">
      <UniScenarioWorkspaceErrorState
        statusKey="uniscenario:segment-error"
