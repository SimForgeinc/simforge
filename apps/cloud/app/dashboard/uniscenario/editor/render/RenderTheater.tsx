...
export function RenderTheater({
  ...
  return (
    <section
      ...
      data-testid="uniscenario-render-theater"
      ...
      <header className="flex shrink-0 flex-col gap-2 border-b render-hairline px-5 py-3.5">
        <div className="flex items-center gap-3">
          <button
            ...
            data-testid="uniscenario-render-theater-back"
            onClick={onBack}
            type="button"
          >
          ...
          <div className="flex min-h-0 flex-col render-hairline xl:border-l">
            ...
            >
              {RAIL_TABS.map((id) => {
                ...
                return (
                  <button
                    aria-controls="uniscenario-render-rail-panel"
                    aria-selected={active}
                    id={`uniscenario-render-rail-tab-${id}`}
                    className={cn(
            ...
            <div
              aria-labelledby={`uniscenario-render-rail-tab-${tab}`}
              className="min-h-0 flex-1 overflow-y-auto"
              id="uniscenario-render-rail-panel"
              role="tabpanel"
            >
              {tab === "files" ? (
