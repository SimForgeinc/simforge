import { extractOpenScenarioExecutionPlan } from "@uniscenarios/openscenario/execution-plan";
import { playbackBundleFromReplay, type PlaybackBundle } from "@uniscenarios/playback";
