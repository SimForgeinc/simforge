...
import { downloadExportArtifact } from "@/app/lib/uniscenario/editor/api";
...
import type { UniScenarioValidationRunDto } from "./api";
...
export function RecordingGalleryTile({
  ...
  return (
    <div
      ...
      data-testid="uniscenario-recording-tile"
...
export function EsminiGalleryTile({ run }: { run: UniScenarioValidationRunDto }) {
  ...
  return (
    <div
      ...
      data-testid="uniscenario-esmini-tile"
