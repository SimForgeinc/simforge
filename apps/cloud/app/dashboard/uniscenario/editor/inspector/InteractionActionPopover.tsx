...
import type { Interaction, Trigger } from "@uniscenarios/scenario-model";
...
export function InteractionActionPopover({
  ...
  if (customRouteTarget) {
    return (
      <EditorDetailsPanel
        ...
        id={`uniscenario-interaction-${interaction.id}`}
        onClose={onClose}
        ...
        testId="uniscenario-custom-route-panel"
      >
        <button
  ...
  return (
    <EditorDetailsPanel
      ...
      testId="uniscenario-interaction-popover"
    >
      <div
        className="space-y-4"
