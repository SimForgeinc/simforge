...
import type { ActorRecord, EditorDocument } from "@uniscenarios/editor-core";
...
export function ActorSensorsSection({
  ...
  return (
    <section aria-labelledby="uniscenario-sensors-heading" className="space-y-1.5">
      <div className="flex items-baseline justify-between gap-2">
        <span
          className="text-[9px] uppercase tracking-[0.12em] text-white/40"
          id="uniscenario-sensors-heading"
        >
          Sensors
        </span>
        {counts.total > 0 ? (
