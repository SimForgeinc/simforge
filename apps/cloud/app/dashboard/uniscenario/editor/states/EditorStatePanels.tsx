...
const QUALITY_PREVIEW_IMAGES: Record<UniScenarioAuthoringQuality, string> = {
 ...
 * status stream and paint through `UniScenarioBootGate` as an overlay, so the
...
export function QualityChooser({
  ...
  onChoose: (quality: UniScenarioAuthoringQuality) => void;
  titleId?: string;
