 ...
 * `qualification/render-determinism/gpu-fingerprint.mjs` (same nvidia-smi query, same
...
/** Same query + field names as qualification/render-determinism/gpu-fingerprint.mjs. */
