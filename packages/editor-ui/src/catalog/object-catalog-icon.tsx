...
import {
  ...
  SignRoadWork,
  TrafficCone,
} from "./art/actor-art/work-zone-props";
import {
  ArrowBoard,
  PortableSignal,
  TemporaryStopSign,
} from "./art/actor-art/work-zone-trailers";
import { Debris, Ladder, Mattress, UnknownProp } from "./art/actor-art/misc-props";
import { CoveredCar, Dumpster, FenceRun, HedgeRun } from "./art/actor-art/occluders";
import { CardboardBox, DownedBranch, TireDebris, TrashBags } from "./art/actor-art/hazards";
import { Excavator, LongPipe, PortableToilet, SpoilPile } from "./art/actor-art/site-props";
import {
  BusShelter,
  FoodCart,
  MailboxCluster,
  ShoppingCart,
} from "./art/actor-art/street-furniture";
